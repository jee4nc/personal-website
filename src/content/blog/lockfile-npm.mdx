...
2. **Vulnerabilidades fantasma.** Sin lockfile, una sub-dependencia puede mutar entre deploys. ¿Recuerdas el incidente de `event-stream` en 2018? Un mantenedor inyectó código malicioso en una versión patch. Si tu lockfile estaba commiteado, no te tocó hasta que *tú* decidieras actualizar. Si no... sorpresa.
